...
<script src="${pageContext.request.contextPath }/js/github-calendar.min.js"> </script>
<link rel="stylesheet" href="${pageContext.request.contextPath }/css/github-calendar.css"/>
<div class="calendar">
